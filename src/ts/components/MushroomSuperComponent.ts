...
export class MushroomSuperComponent extends Phaser.Physics.Arcade.Sprite{
    ...
    constructor(scene: Phaser.Scene, x: number, y: number, private escenario: Phaser.Physics.Arcade.StaticGroup, private mario: MarioComponent) {
        super(scene, x, y, EnumImagenes.ColeccionablesChampinon);
        ...
        this.scene.tweens.add({
            ...
            onComplete: () => {
                ...
                this.scene.physics.add.overlap(this.mario, this, () => {
                    this.destroy();
                    this.mario.recogerPowerUp(EstadoMario.Grande);
                });
            },
        });
    }
